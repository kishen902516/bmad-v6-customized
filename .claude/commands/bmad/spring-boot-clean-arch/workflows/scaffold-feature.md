...
description: "Scaffold complete feature across all layers"
---

Execute the Spring Boot Clean Architecture workflow: **Scaffold complete feature across all layers**

This workflow follows Clean Architecture principles and leverages the Spring Boot Clean Arch module capabilities.

**Workflow Path:** `{project-root}/bmad/spring-boot-clean-arch/workflows/scaffold-feature/workflow.yaml`
