...
description: "Add REST API endpoint"
---

Execute the Spring Boot Clean Architecture workflow: **Add REST API endpoint**

This workflow follows Clean Architecture principles and leverages the Spring Boot Clean Arch module capabilities.

**Workflow Path:** `{project-root}/bmad/spring-boot-clean-arch/workflows/add-rest-endpoint/workflow.yaml`
