---
name: "add-repository"
description: "Add repository with interface in domain"
---

Execute the Spring Boot Clean Architecture workflow: **Add repository with interface in domain**

This workflow follows Clean Architecture principles and leverages the Spring Boot Clean Arch module capabilities.

**Workflow Path:** `{project-root}/bmad/spring-boot-clean-arch/workflows/add-repository/workflow.yaml`
