---
name: "add-use-case"
description: "Add application use case"
---

Execute the Spring Boot Clean Architecture workflow: **Add application use case**

This workflow follows Clean Architecture principles and leverages the Spring Boot Clean Arch module capabilities.

**Workflow Path:** `{project-root}/bmad/spring-boot-clean-arch/workflows/add-use-case/workflow.yaml`
